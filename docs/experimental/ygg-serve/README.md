...
With canonical Ygg `v0.6.2` installed, install the matching first-party
...
The package requires exactly `=0.6.2` and supports GNU/Linux x86_64
...
current `0.6.2` tree is dogfooded with
