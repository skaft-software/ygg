...
With canonical Ygg `v0.6.4` installed, install the matching first-party
...
The package requires exactly `=0.6.4` and supports GNU/Linux x86_64
...
package-layout gate used before the stable workflow publishes v0.6.4.
