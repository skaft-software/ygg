...
Ygg v0.3.3 is a stable navigation, presentation, and native-integration
release. It includes the terminal application, the versioned `ygg-host` process
protocol, and the separately packaged, loopback-only Ygg Serve web interface.
...
The official package must exactly match Ygg `0.3.3`. Supported artifacts
...
worktree on 2026-08-07. Credentialed OpenAI Responses, Anthropic Messages, and
...
See the [changelog](https://github.com/skaft-software/ygg/blob/v0.3.3/CHANGELOG.md),
[extension documentation](../extensions.md), and
[security policy](https://github.com/skaft-software/ygg/blob/v0.3.3/SECURITY.md)
