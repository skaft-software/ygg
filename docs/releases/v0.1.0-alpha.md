...
- Model-aware reasoning controls, collapsed thinking with an expandable
  transcript, and ten responsive bundled themes.
- Cold-start-safe custom endpoints plus five bounded, visible retries for
  non-timeout connection loss.
