...
See the [changelog](https://github.com/skaft-software/ygg/blob/v0.3.0-alpha/CHANGELOG.md)
and [security policy](https://github.com/skaft-software/ygg/blob/v0.3.0-alpha/SECURITY.md)
