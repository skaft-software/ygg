...
- Fixed terminal-owned redraws so temporary completion/report surfaces do not
  advance native history and streamed-layout contractions do not leave blank
  live-grid rows; `/context` now repaints completely after the slash popup.
