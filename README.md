...
<p align="center">
  <a href="https://github.com/skaft-software/ygg/releases/tag/v0.4.0"><img alt="Release: 0.4.0" src="https://img.shields.io/badge/release-0.4.0-536dfe?style=flat-square"></a>
...
[ripgrep](https://github.com/BurntSushi/ripgrep). Prebuilt `v0.4.0`
...
```sh
scripts/build-ygg-image.sh ygg:0.4.0
docker run --rm -it \
  -e ANTHROPIC_API_KEY \
  -v "$PWD:/workspace" \
  ygg:0.4.0 --model claude-sonnet-4-6
```
...
| [Release notes](docs/releases/v0.4.0.md) | Current installation, highlights, compatibility notes, and limitations. |
