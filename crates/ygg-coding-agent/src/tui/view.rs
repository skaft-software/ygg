...
use crate::tui::theme::{ModelLab, ThemeDensity, ThemeSurfaceChrome, YggTheme};

#[cfg(test)]
use self::assistant_block::reasoning_heading_from_block;
use self::assistant_block::AssistantBlock;
use self::bash_render::{render_bash_row, render_compact_bash_output};
...
use self::native_scrollback::{
    render_shell, render_shell_update_with_cursor, synchronize_shell_frame,
};
#[cfg(test)]
use self::native_scrollback::{render_shell_at, render_shell_update};
...
use self::surface_frame::decorate_surface;
#[cfg(test)]
use self::surface_frame::event_margin_marker;
use self::surface_layout::{compile_surface_plan, surface_roles};
...
use self::transcript_cache::{RenderedTranscriptBlock, SurfaceGeometry, TranscriptCache};
...
use self::viewport::{
    max_scroll_for_available, max_scroll_from_bottom, render_shell_viewport_at,
