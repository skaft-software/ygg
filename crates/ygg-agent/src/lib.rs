...
pub use extension::{EventObserver, Extension, ExtensionHost, ToolCallHook, ToolSnapshot};
...
pub use extension_process::{
    ...
    negotiate_extension_api_v03, AgentSessionListRequest, AgentSessionMessageRequest,
    ...
    ExtensionCatalogEpochZero, ExtensionCatalogFlagDefinition, ExtensionCatalogFlagKind,
    ExtensionCatalogProviderDeclaration, ExtensionCatalogReplaceRequest,
    ExtensionCatalogReplaceResponse, ExtensionCatalogShortcutDefinition, ExtensionContributions,
    ExtensionDiagnostic, ExtensionDiagnosticLevel, ExtensionDocumentChunk,
    ExtensionDocumentReadRequest, ExtensionDocumentReadResponse, ExtensionDocumentReference,
    ExtensionEffect, ExtensionEffectJournal, ExtensionEntrypoint, ExtensionEvent,
    ExtensionExecutionContext, ExtensionFilesystemAccess, ExtensionHealthSnapshot,
    ExtensionHealthState, ExtensionHook, ExtensionHookDisposition, ExtensionHookOutput,
    ExtensionHostServiceDeclaration, ExtensionHostServiceDescriptor, ExtensionHostServiceLimits,
    ExtensionHostServiceName, ExtensionHostServiceRequest, ExtensionHostServiceResponse,
    ExtensionHostServiceScope, ExtensionHostServiceVersion, ExtensionHostState,
    ExtensionInputRequest, ExtensionInputResponse, ExtensionInvocation, ExtensionLifecycleEvent,
    ExtensionLifecycleOutcome, ExtensionManifest, ExtensionManifestInput, ExtensionMessageDelivery,
    ExtensionNegotiatedProtocol, ExtensionNegotiatedV03, ExtensionNotification,
    ExtensionNotificationLevel, ExtensionOperationKind, ExtensionOperationMode,
    ExtensionOperationToken, ExtensionOrderedEvent, ExtensionOrderedEventBatch,
    ExtensionOrderedEventContext, ExtensionOrderedEventName, ExtensionOrderedEventResult,
    ExtensionOrderedObservation, ExtensionPolicy, ExtensionPolicyEvaluationRequest,
    ExtensionPolicyEvaluationResponse, ExtensionPrincipal, ExtensionProcess,
    ExtensionProgressEncoding, ExtensionProgressEvent, ExtensionProgressStream,
    ExtensionProtocolLimits, ExtensionProtocolRequest, ExtensionProtocolResponse,
    ExtensionProtocolV03Request, ExtensionProtocolV03Response, ExtensionReloadReport,
    ExtensionRequestId, ExtensionResourceOwner, ExtensionRoot, ExtensionRuntimeConfig,
    ExtensionRuntimeError, ExtensionSource, ExtensionStatusContribution, ExtensionTrust,
    ExtensionUiSurface, OperationToken, ProcessFence, RenderedToolCall, SessionOwner,
    ...
    DELEGATION_TELEMETRY_SCHEMA, EXTENSION_API_0_3_REQUIRED_FEATURES, EXTENSION_API_VERSION,
    ...
    EXTENSION_FEATURE_CATALOG_TRANSACTIONS, EXTENSION_FEATURE_CONTENT_PARTS,
    EXTENSION_FEATURE_DELEGATION_TELEMETRY, EXTENSION_FEATURE_DOCUMENT_STREAMS,
    EXTENSION_FEATURE_DYNAMIC_TOOLS, EXTENSION_FEATURE_EFFECT_TRANSACTIONS,
    EXTENSION_FEATURE_LIFECYCLE_EVENTS, EXTENSION_FEATURE_ORDERED_EVENTS,
    EXTENSION_FEATURE_OWNER_CONTEXT, EXTENSION_FEATURE_POLICY_INTENTS,
    ...
    MAX_EXTENSION_CHILD_REQUEST_IDS_PER_GENERATION, MAX_EXTENSION_DOCUMENT_BYTES,
    MAX_EXTENSION_DOCUMENT_CHUNK_BYTES, MAX_EXTENSION_DOCUMENT_WINDOW, MAX_EXTENSION_EFFECTS,
    MAX_EXTENSION_EFFECT_JOURNAL_BYTES, MAX_EXTENSION_IDENTITY_BYTES,
    MAX_EXTENSION_IDENTITY_RECORDS, MAX_EXTENSION_INLINE_SEMANTIC_BYTES,
    MAX_EXTENSION_INPUT_PROMPT_BYTES, MAX_EXTENSION_INPUT_VALUE_BYTES,
    MAX_EXTENSION_MANIFEST_BYTES, MAX_EXTENSION_ORDERED_EVENT_BATCH,
    MAX_EXTENSION_ORDERED_EVENT_BATCH_BYTES, MAX_EXTENSION_RESULT_CONTENT_PARTS,
