...
pub use extension_process::{
    ...
    ExtensionHostServiceScope, ExtensionHostServiceVersion, ExtensionHostState, ExtensionInputRequest, ExtensionInputResponse, ExtensionInvocation,
    ExtensionLifecycleEvent, ExtensionLifecycleOutcome, ExtensionManifest, ExtensionManifestInput,
    ExtensionMessageDelivery, ExtensionNegotiatedProtocol, ExtensionNegotiatedV03,
    ExtensionNotification, ExtensionNotificationLevel, ExtensionOperationKind,
    ExtensionOperationMode, ExtensionOperationToken, ExtensionOrderedEvent,
    ExtensionOrderedEventBatch, ExtensionOrderedEventContext, ExtensionOrderedEventName,
    ExtensionOrderedEventResult, ExtensionOrderedObservation, ExtensionPolicy, ExtensionPolicyEvaluationRequest, ExtensionPolicyEvaluationResponse,
    ExtensionPrincipal, ExtensionProcess, ExtensionProgressEncoding, ExtensionProgressEvent,
    ExtensionProgressStream, ExtensionProtocolLimits, ExtensionProtocolRequest,
    ExtensionProtocolResponse, ExtensionProtocolV03Request, ExtensionProtocolV03Response,
    ...
    ExtensionTrust, ExtensionUiSurface, OperationToken, ProcessFence, RenderedToolCall,
    SessionOwner, ToolCallOutput as ExtensionToolCallOutput, ToolCatalogUpdateResponse,
