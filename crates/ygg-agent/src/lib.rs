...
pub use extension_process::{
    ...
    ExtensionCatalogProviderDeclaration, ExtensionCatalogShortcutDefinition,
    ExtensionContributions, ExtensionDiagnostic, ExtensionDiagnosticLevel, ExtensionDocumentChunk,
    ExtensionDocumentReference, ExtensionEffect, ExtensionEffectJournal, ExtensionEntrypoint,
    ...
    ExtensionHostServiceName, ExtensionHostServiceScope, ExtensionHostServiceVersion,
    ExtensionHostState, ExtensionInputRequest, ExtensionInputResponse, ExtensionInvocation,
    ...
    ExtensionOrderedEventBatch, ExtensionOrderedEventName, ExtensionOrderedEventResult,
    ExtensionPolicy, ExtensionPolicyEvaluationRequest, ExtensionPolicyEvaluationResponse,
