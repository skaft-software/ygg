...
describe("sidebar session lifecycle", () => {
  ...
  it("shows working spinners and unread update dots in session rows", () => {
    ...
    const working = screen.getByRole("button", {
      name: "Open task Working session, Working",
    });
    ...
    const complete = screen.getByRole("button", {
      name: "Open task Completed session, Done",
    });
    ...
    const attention = screen.getByRole("button", {
      name: "Open task Needs input, Needs attention",
    });
    ...
    const idle = screen.getByRole("button", {
      name: "Open task Idle session, Ready",
    });
